NoBrainer.configure do |config|
  ...
  database_name = "#{Rails.application.class.parent_name.underscore}_#{Rails.env}"
  config.rethinkdb_url = "rethinkdb://db:28015/#{database_name}"
  ...
  config.max_retries_on_connection_failure = 0
